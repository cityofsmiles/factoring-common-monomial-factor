...
export default function App() {
  ...
  const base =
    import.meta.env.MODE === "development"
      ? "/flashcards.json"
      : "https://cityofsmiles.github.io/factoring-common-monomial-factor/flashcards.json";
  ...
  return (
    <div className="flashcards-container">
      <h1>Factoring Polynomials with Common Monomial Factor</h1>
      ...
      <input
        ...
        placeholder="Type factored form, e.g. 2x(x^3 - 9)"
